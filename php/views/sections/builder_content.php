...
<div id="construction-wrapper">
	...
	<div class="build-section" id="build-section">
		...
		<div class="build-area-side">
			...
			<div class="side-option lock-option" data-action="10" title="Lock" data-toggle="modal" data-target="#lock-genericseatterm-dialog"></div>
			<div class="side-option numbering-option" data-action="11" title="Change numbering" data-toggle="modal" data-target="#genericseatterm-numbering-dialog"></div>
		</div>
	...
	<div class="build-controls">
		...
		<div id="build-section-message-wrap" data-toggle="modal" data-target="#limit-dialog">
			<span class="message-text"><span style="vertical-align:middle"><?php esc_html_e('Pending and booked genericseatterms can\'t be deleted', 'seatreg');?></span><span class="more-message-btn"></span></span>
		</div>
	...
	<?php require( SEATREG_PLUGIN_FOLDER_DIR . 'php/views/modals/genericseatterm-price-modal.php' ); ?>
	...
	<div class="modal vert-modal fade" id="lock-genericseatterm-dialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog vert-modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel"><?php esc_html_e('Lock genericseatterms/places', 'seatreg');?></h4>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			</div>
			<div class="modal-body">
				<div class="set-password-wrap">
					<div><label for="password-for-all-selected"><?php esc_html_e('Fill password to all selected genericseatterms', 'seatreg'); ?></label></div>
				...
				<div id="selected-genericseatterms-for-locking"></div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal"><?php esc_html_e('Close', 'seatreg');?></button>
				<button type="button" class="btn btn-primary" id="set-genericseatterm-locks"><?php esc_html_e('Apply', 'seatreg');?></button>
			</div>
		</div>
		</div>
	</div>

	<div class="modal vert-modal fade" id="genericseatterm-numbering-dialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog vert-modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<div class="alert alert-primary d-none" id="genericseatterm-nr-change-no-selection"><?php esc_html_e('No genericseatterms/places selected', 'seatreg'); ?></div>
				<div class="alert alert-primary d-none" id="genericseatterm-nr-change-warning"><?php esc_html_e('Pending or booked genericseatterm numbers can\'t be changed', 'seatreg'); ?></div>
				<div id="genericseatterm-numbering-wrap">
					<div>
						<div><label for="genericseatterm-prefix"><?php esc_html_e('Seat prefix for selected genericseatterms', 'seatreg'); ?></label></div>
						<input type="text" id="genericseatterm-prefix" style="width:60px" />
						<button type="button" class="btn btn-success btn-sm" id="set-genericseatterm-prefix"><?php esc_html_e('Set prefix', 'seatreg'); ?></button>
					</div><br>
					<div>
						<div><label for="genericseatterm-reorder"><?php esc_html_e('Reorder selected genericseatterms starting from', 'seatreg'); ?></label></div>
						<input type="number" id="genericseatterm-reorder" size="3" style="width:60px" />
						<button type="button" class="btn btn-success btn-sm" id="reorder-genericseatterms"><?php esc_html_e('Reorder genericseatterms', 'seatreg'); ?></button>
					</div>
				</div>
			</div>
			<div class="modal-footer">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="help-dialog-row">
						...
						<p class="help-dialog-text">
							<?php esc_html_e('With this tool you can create genericseatterms/places. Simply click on gray dotted box and new genericseatterm/place will be created. You can create multiple genericseatterms/places at once by dragging cursor over gray boxes.', 'seatreg');?>
						</p>
					</div>
					...
					<div class="help-dialog-row">
						...
						<p class="help-dialog-text">
							<?php esc_html_e('Lets you add prices to genericseatterms/places. You also need to configure paypal in settings to enable payments.', 'seatreg');?>
						</p>
					</div>
					...
					<div class="help-dialog-row">
						...
						<p class="help-dialog-text">
							<?php esc_html_e('Lets you lock or set password to genericseatterms/places. When genericseatterm/place is locked then only admin can book it using booking-manager. If password is added then it is required before booking can be made.', 'seatreg');?>
						</p>
					</div>

					<div class="help-dialog-row">
						<div class="guide-item2 guide-item-genericseatterm-nr"></div>
						<p class="help-dialog-text">
							<?php esc_html_e('Lets you change genericseatterm/place numbers. Pending and booked genericseatterm/place numbers can\'t be changed.', 'seatreg');?>
						</p>
					</div>
