...
function seatreg_generate_registration_strings() {
	...
	$translations->openSeatsInRoom_ = esc_html__('Open genericseatterms in the room: ', 'seatreg');
	...
	$translations->genericseatterm = esc_html__('genericseatterm', 'seatreg');
    ...
    $translations->_genericseattermSelected = esc_html__(' genericseatterm selected', 'seatreg');
    $translations->_genericseattermsSelected = esc_html__(' genericseatterms selected', 'seatreg');
    ...
    $translations->selectingGuide = esc_html__('Select a genericseatterm you want to add to booking', 'seatreg');
    ...
    $translations->maxSeatsToAdd = esc_html__('Total genericseatterms you can add to booking is ', 'seatreg');
    $translations->maxPlacesToAdd = esc_html__('Total places you can add to booking is ', 'seatreg');
    $translations->genericseattermCosts_ = esc_html__('Booking this genericseatterm costs ', 'seatreg');
    ...
    $translations->genericseattermIsLocked = esc_html__('Seat is locked', 'seatreg');
...
function seatreg_generate_admin_strings() {
    ...
    $translations->genericseattermNotExist = esc_html__('Seat does not exist', 'seatreg');
    $translations->genericseattermIdNotExist = esc_html__('Seat id dose not exist', 'seatreg');
    $translations->genericseattermAlreadyBookedPending = esc_html__('Seat is already booked/pending', 'seatreg');
    ...
    $translations->_cantDelRoomBecause = esc_html__(' because it contains pending or confirmed genericseatterms. You must remove them with manager first.', 'seatreg');
    ...
    $translations->pendingSeat = esc_html__('Pending genericseatterm', 'seatreg');
    $translations->pendingPlace = esc_html__('Pending place', 'seatreg');
    $translations->confirmedSeat = esc_html__('Approved genericseatterm', 'seatreg');
    ...
    $translations->noSeatsSelected = esc_html__('No genericseatterms/places selected!', 'seatreg');
    $translations->emailNotCorrect = esc_html__('Email address is not correct', 'seatreg');
    ...
    $translations->duplicateSeatDetected = esc_html__('Duplicate genericseatterm detected!', 'seatreg');
    $translations->emailTemplateNotCorrect = esc_html__('Email template is missing required keywords', 'seatreg');
    $translations->lockSeat = esc_html__('Lock genericseatterm', 'seatreg');
